...
public class Request<S, T extends Response> {
	...
	public Request(String method, List<S> params, OmniService omniService,
			Class<T> type) {
		this.method = method;
		this.params = params;
	...
	public T send() throws IOException {
		return omniService.send(this, responseType);
	}

	public CompletableFuture<T> sendAsync() {
		return omniService.sendAsync(this, responseType);
	}
